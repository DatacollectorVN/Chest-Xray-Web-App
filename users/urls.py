...
from .views import home, profile, RegisterView, ImagePredictionView, ImagePredictionCreate, ImagePredictionUpdate, ImagePredictionDelete, ImagePredictionSubmitSuccess, test, news_1, news_2, news_3
